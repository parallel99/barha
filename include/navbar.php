            ...
            <div id="navbarNavDropdown" class="navbar-collapse collapse">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <form class="dropdown-menu profile-menu dropdown-menu-right" method="post"
                              aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="profile"><span aria-hidden="true"
                                                                          class="fa fa-user-o fa-fw"></span>Profil</a>
                            <a class="dropdown-item" href="/favourite"><span aria-hidden="true"
                                                                             class="fa fa-heart-o fa-fw"></span>Kedvenceim</a>
                            <a class="dropdown-item" href="/upload_recipe"><span aria-hidden="true"
                                                                                 class="fa fa-upload fa-fw"></span>Recept
                                feltöltés</a>
                            <a class="dropdown-item" href="/myRecipes"><span aria-hidden="true"
                                                                             class="fa fa-pencil-square-o fa-fw"></span>Recepteim
                                szerkesztése</a>
                            <?php
                            ...
                            <button type="submit" name="logout" class="dropdown-item"><span aria-hidden="true"
                                                                                            class="fa fa-sign-out fa-fw"></span>Kijelentkezés
                            </button>
                        </form>
                    </li>
                </ul>
